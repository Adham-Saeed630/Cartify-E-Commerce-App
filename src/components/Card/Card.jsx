    ...
    return(
        <div className="flex flex-col justify-between items-center gap-4 w-full">
            ...
            <div className="flex flex-col flex-wrap items-center sm:flex-row gap-2 w-full text-nowrap">
                <button className="w-full sm:flex-1 px-3 sm:px-5 py-2 rounded-2xl bg-(--background-light) border-(--secondary-dark) border font-semibold text-sm sm:text-md text-(--text-light) text-center">Add to Cart</button>
                <button className="w-full sm:flex-1 px-3 sm:px-5 py-2 rounded-2xl bg-(--background-dark) border-(--secondary-light) border font-semibold text-sm sm:text-md text-(--text-dark) text-center">Buy Now</button>
            </div>
        </div>
    )
}